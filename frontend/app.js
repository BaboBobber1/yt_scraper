...
class Dashboard {
  ...
  cacheElements() {
    this.el = {
      ...
      modal: this.root.querySelector('#blacklistModal'),
      modalClose: this.root.querySelector('#blacklistCloseBtn'),
      modalCancel: this.root.querySelector('#blacklistCancelBtn'),
      modalForm: this.root.querySelector('#blacklistForm'),
      modalFile: this.root.querySelector('#blacklistFile'),
      modalSummary: this.root.querySelector('#blacklistSummary'),
      modalSubmit: this.root.querySelector('#blacklistSubmitBtn'),
